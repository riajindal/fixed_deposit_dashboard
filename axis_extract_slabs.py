...
url = 'https://www.paisabazaar.com/fixed-deposit/axis-bank-fd-rates/'
...
df_1 = pd.DataFrame(hdfc_tenure_rates)
...
df_1.to_csv('axis_slabs.csv', index=False, mode='w')
